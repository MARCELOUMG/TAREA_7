...
const appContenedor = document.querySelector("#ejer1_0");
...
const appContenedor1 = document.querySelector("#ejer1_1");
...
const appContenedor2 = document.querySelector("#ejer1_2");
